...
import TryAgentDemo from '../components/TryAgentDemo';
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10">
          <div className="space-y-10">
            ...
            <a 
              ...
              className="inline-flex items-center gap-3 px-4 py-2 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md hover:border-brand transition-all"
            >
              <span className="relative w-8 h-8 rounded-xl bg-brand text-white flex items-center justify-center shadow-brand/30 shadow-md overflow-visible">
                <span className="absolute inset-0 rounded-xl bg-white/20 animate-ping"></span>
                <i className="fas fa-phone relative z-10"></i>
              </span>
              <div className="flex items-center gap-3">
                <span className="text-sm font-black text-slate-900 dark:text-white tracking-tight">+91-8898-7-24-365</span>
                <span className="px-2 py-0.5 text-[9px] font-black uppercase tracking-widest bg-brand/10 text-brand rounded-full animate-pulse">24×7×365</span>
              </div>
            </a>
